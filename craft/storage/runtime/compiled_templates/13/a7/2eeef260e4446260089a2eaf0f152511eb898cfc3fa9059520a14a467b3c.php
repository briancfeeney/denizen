...
class __TwigTemplate_13a72eeef260e4446260089a2eaf0f152511eb898cfc3fa9059520a14a467b3c extends Craft\BaseTemplate
{
...
\t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["entryType"]) {
            ...
            echo "\" data-name=\"";
            echo twig_escape_filter($this->env, $this->getAttribute($context["entryType"], "name", array()), "html", null, true);
            echo "\">
