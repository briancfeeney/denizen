...
\t\t\t";
            // line 43
            echo $context["forms"]->getcheckboxField(array("label" => \Craft\Craft::t("Show title fields"), "name" => "hasTitleField", "toggle" => "titleLabel-container", "reverseToggle" => "titleFormat-container", "checked" => $this->getAttribute((isset($context["entryType"]) ? $context["entryType"] : null), "hasTitleField")));
            // line 49
            echo "

\t\t\t<div id=\"titleLabel-container\"";
            // line 51
            if ((!$this->getAttribute((isset($context["entryType"]) ? $context["entryType"] : null), "hasTitleField"))) {
                echo " class=\"hidden\"";
            }
            echo ">
\t\t\t\t";
...
\t\t\t\t";
            // line 64
            echo $context["forms"]->gettextField(array("label" => \Craft\Craft::t("Title Format"), "instructions" => \Craft\Craft::t("What the auto-generated entry titles should look like. You can include tags that output entry properties, such as {ex}.", array("ex" => "<code>{myCustomField}</code>")), "id" => "titleFormat", "name" => "titleFormat", "value" => $this->getAttribute((isset($context["entryType"]) ? $context["entryType"] : null), "titleFormat"), "errors" => $this->getAttribute((isset($context["entryType"]) ? $context["entryType"] : null), "getErrors", array(0 => "titleFormat"), "method"), "required" => true));
            // line 72
            echo "
\t\t\t</div>
\t\t";
